...
import patchcoremain
from patchcoremain import patchcore as patchcore_model
...
def _load_patchcore_from_path(load_path):
    ...
    patchcore_instance.load_from_path(
        ...
        nn_method=patchcoremain.common.FaissNN(False, 4),
    )
    return patchcore_instance
...
def _approximate_greedycoreset_sampler_with_reduction(
    ...
    return patchcoremain.sampler.ApproximateGreedyCoresetSampler(
